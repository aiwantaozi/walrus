...
type TemplateSpecApplyConfiguration struct {
	...
	HelmOCIChart   *HelmOCIChartApplyConfiguration  `json:"helmOCIChart,omitempty"`
	HelmChart      *HelmChartApplyConfiguration     `json:"helmChart,omitempty"`
}
...
// WithHelmOCIChart sets the HelmOCIChart field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the HelmOCIChart field is set to the value of the last call.
func (b *TemplateSpecApplyConfiguration) WithHelmOCIChart(value *HelmOCIChartApplyConfiguration) *TemplateSpecApplyConfiguration {
	b.HelmOCIChart = value
	return b
}

// WithHelmChart sets the HelmChart field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the HelmChart field is set to the value of the last call.
func (b *TemplateSpecApplyConfiguration) WithHelmChart(value *HelmChartApplyConfiguration) *TemplateSpecApplyConfiguration {
	b.HelmChart = value
	return b
}
