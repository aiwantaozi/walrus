...
const (
	...
	WalrusFilename    = "walrus-file.yaml"
)

// SequenceWalrusFileKeys is the sequence of walrus file keys.
var SequenceWalrusFileKeys = []string{"version", "resources", "variables"}

// WalrusFile is the spec for the WalrusFile.
type WalrusFile struct {
	Version   string         `json:"version,omitempty" yaml:"version,omitempty"`
	Resources []ResourceSpec `json:"resources,omitempty" yaml:"resources,omitempty"`
	Variables []VariableSpec `json:"variables,omitempty" yaml:"variables,omitempty"`
}
...
// VariableSpec include the field walrus file related.
