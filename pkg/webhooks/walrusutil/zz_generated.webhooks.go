...
func GetValidatingWebhookConfiguration(n string, c v1.WebhookClientConfig) *v1.ValidatingWebhookConfiguration {
	return &v1.ValidatingWebhookConfiguration{
		...
		Webhooks: []v1.ValidatingWebhook{
			vwh_walrus_pkg_webhooks_walrusutil_ScheduleTaskWebhook(c),
		},
	}
}
...
func (*ScheduleTaskWebhook) ValidatePath() string {
	return "/validate-walrusutil-seal-io-v1-scheduletask"
}

func vwh_walrus_pkg_webhooks_walrusutil_ScheduleTaskWebhook(c v1.WebhookClientConfig) v1.ValidatingWebhook {
	path := "/validate-walrusutil-seal-io-v1-scheduletask"
	...
	return v1.ValidatingWebhook{
		Name:         "validate.walrusutil.seal.io.v1.scheduletask",
		ClientConfig: *cc,
